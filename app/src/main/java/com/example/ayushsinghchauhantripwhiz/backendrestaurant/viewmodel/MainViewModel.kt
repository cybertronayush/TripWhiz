package `in`.ayushsingh.backendrestaurant.viewmodel


import `in`.ayushsingh.backendrestaurant.modal.LocationSuggestion
import `in`.ayushsingh.backendrestaurant.modal.Restaurant
import `in`.ayushsingh.backendrestaurant.modal.ResturentInCitySearchResponse
import `in`.ayushsingh.backendrestaurant.modal.citySearchResponse
import `in`.ayushsingh.backendrestaurant.room.DbCities
import `in`.ayushsingh.backendrestaurant.util.logit
import `in`.ayushsingh.backendrestaurant.util.myutil
import `in`.ayushsingh.backendrestaurant.volley.MySingleton
